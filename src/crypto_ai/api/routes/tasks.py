...
from crypto_ai.api.deps import TaskServiceDep
from crypto_ai.schemas.task import CeleryWorkerTask, TaskListResponse, TaskRecordResponse
...
def _get_registered_workers() -> set[str]:
    ...
    try:
        ...
        from crypto_ai.tasks.celery_app import WORKER_REGISTRY_PREFIX, celery_app
...
async def stop_task(task_id: str, service: TaskServiceDep) -> dict:
    ...
    from crypto_ai.tasks.celery_app import request_graceful_stop
