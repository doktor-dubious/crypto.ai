...
from crypto_ai.schemas.cohort_audit import CohortResult
from crypto_ai.services.llm_usage import record_anthropic_usage

router = APIRouter()
log = structlog.get_logger("crypto_ai.llm")
