...
from crypto_ai.api.deps import CustomerConfigurationServiceDep, DbSession, TaskServiceDep
...
from crypto_ai.schemas.customer_configuration import CustomerConfigurationUpdate
from crypto_ai.schemas.optimization import (
...
def _run_to_response(run: OptimizationRun) -> OptimizationRunResponse:
    ...
    return OptimizationRunResponse(
        ...
        optimize_covariate_weekday=run.optimize_covariate_weekday,
        optimize_covariate_price=run.optimize_covariate_price,
        optimize_covariate_pad=run.optimize_covariate_pad,
...
async def start_optimization(
    ...
    """
    from crypto_ai.tasks.optimization import run_optimization_task
    ...
    optimization_run = OptimizationRun(
        ...
        optimize_covariate_handling=data.optimize_covariate_handling,
        optimize_covariate_weekday=data.optimize_covariate_weekday,
        optimize_covariate_price=data.optimize_covariate_price,
        optimize_covariate_pad=data.optimize_covariate_pad,
...
async def apply_optimization_settings(
    ...
    if config:
        ...
        from crypto_ai.schemas.customer_configuration import CustomerConfigurationCreate
