...
from crypto_ai.api.deps import OutletGroupServiceDep, PredictionAdjustmentServiceDep
from crypto_ai.schemas.outlet import OutletResponse
...
from crypto_ai.schemas.prediction_adjustment import PredictionAdjustmentResponse
