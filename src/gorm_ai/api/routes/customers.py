...
from gorm_ai.api.deps import CustomerConfigurationServiceDep, CustomerServiceDep
from gorm_ai.schemas.customer import CustomerCreate, CustomerResponse, CustomerUpdate
