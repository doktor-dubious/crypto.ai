...
# YingLong runtime dependencies (flash_attn must be compiled for the target GPU)
uv pip install flash-attn xformers lightning-utilities rotary-emb dropout-layer-norm
